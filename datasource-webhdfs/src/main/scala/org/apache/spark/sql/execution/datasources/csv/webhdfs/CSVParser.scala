...
package org.apache.spark.sql.execution.datasources.csv.webhdfs
 ...
 */
abstract class CsvReader(params: CSVOptions, headers: Seq[String]) {
 ...
 */
class LineCsvWriter(params: CSVOptions, headers: Seq[String]) extends Logging {
 ...
 * @param params Parameters object
 */
class LineCsvReader(params: CSVOptions)
